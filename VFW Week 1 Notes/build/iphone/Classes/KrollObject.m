...
//@interface VFWWeek1NotesObject : NSObject
//@end

@interface VFWWeek1NotesObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[VFWWeek1NotesObject class]])
		{
			for (NSString *key in [[(VFWWeek1NotesObject*)o modules] allKeys])
			{
