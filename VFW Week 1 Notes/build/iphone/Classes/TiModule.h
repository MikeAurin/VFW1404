...
/**
 The base class for all VFWWeek1Notes modules
 */
...
/**
 VFWWeek1Notes Platform calls this method on startup.
 */
-(void)startup;

/**
 VFWWeek1Notes Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 VFWWeek1Notes Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 VFWWeek1Notes Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 VFWWeek1Notes Platform calls this method on resume.
 @param sender The sender of the event.
 */
