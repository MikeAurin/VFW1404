...
@interface VFWWeek1NotesObject : KrollCoverageObject {
#else
@interface VFWWeek1NotesObject : KrollObject {
#endif
@private
...
extern NSString * VFWWeek1Notes$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	VFWWeek1NotesObject *_vfwweek1notes;
    KrollObject* console;
	BOOL shutdown;
