...
//Rare exceptions to indicate a bug in the _vfwweek1notes code (Eg, function that a subclass should have implemented)
...
/**
 The base class for VFWWeek1Notes proxies.
 */
