...
/**
 Base class for all VFWWeek1Notes views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the VFWWeek1Notes view hierarchy (such as wrapped iOS UIViews) was touched.
