...
// in simulator we redefine to format for VFWWeek1Notes Developer console
...
{\
	NSString * exceptionName = [@"org.vfwweek1notes." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.vfwweek1notes";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIVFWWeek1NotesNativeItemNone = -1, 
	UIVFWWeek1NotesNativeItemSpinner = -2,
	UIVFWWeek1NotesNativeItemProgressBar = -3,
	
	UIVFWWeek1NotesNativeItemSlider = -4,
	UIVFWWeek1NotesNativeItemSwitch = -5,
	UIVFWWeek1NotesNativeItemMultiButton = -6,
	UIVFWWeek1NotesNativeItemSegmented = -7,
	
	UIVFWWeek1NotesNativeItemTextView = -8,
	UIVFWWeek1NotesNativeItemTextField = -9,
	UIVFWWeek1NotesNativeItemSearchBar = -10,
	
	UIVFWWeek1NotesNativeItemPicker = -11,
	UIVFWWeek1NotesNativeItemDatePicker = -12,
	
	UIVFWWeek1NotesNativeItemInfoLight = -13,
	UIVFWWeek1NotesNativeItemInfoDark = -14,
	
	UIVFWWeek1NotesNativeItemDisclosure = -15,
	
	UIVFWWeek1NotesNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all VFWWeek1Notes instances of
